...
In FRC, robots are programmed using the Java language alongside the [WPILib](https://docs.wpilib.org/en/stable/)
...
This is the comptuer you are writing code for! In these tutorials, we will write our robot
